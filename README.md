...
| `rbac.serviceAccount`                                              | The [serviceAccount](https://kubernetes.io/docs/tasks/configure-pod-container/configure-service-account/) to use for RBAC.                   |
...
| `ingress.annotations.nginx.ingress.kubernetes.io/proxy-body-size`  | Request larger that this will result in a `413 Payload Too Large`.                                                                           |
| `ingress.annotations.nginx.ingress.kubernetes.io/proxy-read-timeout` | Timeout value for read operations.                                                                                                                                            |
...
| `extraFileMappings.*                                               | Defined the contents of extra files to be created.                                                                                                                                               |
