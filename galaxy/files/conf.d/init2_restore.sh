...
CREATE TABLE public.history_dataset_association (
    ...
    version integer,
    validated_state character varying(64) DEFAULT 'unknown'::character varying NOT NULL,
    validated_state_message text
);
...
--
-- Name: interactivetool_entry_point; Type: TABLE; Schema: public; Owner: galaxydbuser
--

CREATE TABLE public.interactivetool_entry_point (
    id integer NOT NULL,
    job_id integer,
    name text,
    token text,
...
ALTER TABLE public.interactivetool_entry_point OWNER TO galaxydbuser;

--
-- Name: interactivetool_entry_point_id_seq; Type: SEQUENCE; Schema: public; Owner: galaxydbuser
--

CREATE SEQUENCE public.interactivetool_entry_point_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.interactivetool_entry_point_id_seq OWNER TO galaxydbuser;

--
-- Name: interactivetool_entry_point_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: galaxydbuser
--

ALTER SEQUENCE public.interactivetool_entry_point_id_seq OWNED BY public.interactivetool_entry_point.id;
...
--
-- Name: job_container_association; Type: TABLE; Schema: public; Owner: galaxydbuser
--

CREATE TABLE public.job_container_association (
    id integer NOT NULL,
    job_id integer,
    container_type text,
    container_name text,
    container_info bytea,
    created_time timestamp without time zone,
    modified_time timestamp without time zone
);


ALTER TABLE public.job_container_association OWNER TO galaxydbuser;

--
-- Name: job_container_association_id_seq; Type: SEQUENCE; Schema: public; Owner: galaxydbuser
--

CREATE SEQUENCE public.job_container_association_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.job_container_association_id_seq OWNER TO galaxydbuser;

--
-- Name: job_container_association_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: galaxydbuser
--

ALTER SEQUENCE public.job_container_association_id_seq OWNED BY public.job_container_association.id;
...
--
-- Name: interactivetool_entry_point id; Type: DEFAULT; Schema: public; Owner: galaxydbuser
--

ALTER TABLE ONLY public.interactivetool_entry_point ALTER COLUMN id SET DEFAULT nextval('public.interactivetool_entry_point_id_seq'::regclass);
...
--
-- Name: job_container_association id; Type: DEFAULT; Schema: public; Owner: galaxydbuser
--

ALTER TABLE ONLY public.job_container_association ALTER COLUMN id SET DEFAULT nextval('public.job_container_association_id_seq'::regclass);
...
COPY public.dataset (id, create_time, update_time, state, deleted, purged, purgable, external_filename, _extra_files_path, file_size, total_size, object_store_id, uuid, created_from_basename) FROM stdin;
\.
...
COPY public.implicit_collection_jobs_job_association (id, implicit_collection_jobs_id, job_id, order_index) FROM stdin;
\.
...
--
-- Data for Name: interactivetool_entry_point; Type: TABLE DATA; Schema: public; Owner: galaxydbuser
--

COPY public.interactivetool_entry_point (id, job_id, name, token, tool_port, host, port, protocol, entry_url, info, configured, deleted, created_time, modified_time) FROM stdin;
\.
...
COPY public.library_dataset_dataset_association (id, library_dataset_id, dataset_id, create_time, update_time, copied_from_history_dataset_association_id, copied_from_library_dataset_dataset_association_id, name, info, blurb, peek, extension, metadata, parent_id, designation, deleted, visible, user_id, message, state, tool_version, extended_metadata_id, validated_state, validated_state_message) FROM stdin;
\.
...
COPY public.workflow (id, create_time, update_time, stored_workflow_id, name, has_cycles, has_errors, uuid, parent_workflow_id, reports_config) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.galaxy_session_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.galaxy_session_to_history_id_seq', 1, false);
...
--
-- Name: interactivetool_entry_point_id_seq; Type: SEQUENCE SET; Schema: public; Owner: galaxydbuser
--

SELECT pg_catalog.setval('public.interactivetool_entry_point_id_seq', 1, false);


--
-- Name: job_container_association_id_seq; Type: SEQUENCE SET; Schema: public; Owner: galaxydbuser
--

SELECT pg_catalog.setval('public.job_container_association_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.worker_process_id_seq', 1, false);
...
--
-- Name: interactivetool_entry_point interactivetool_entry_point_pkey; Type: CONSTRAINT; Schema: public; Owner: galaxydbuser
--

ALTER TABLE ONLY public.interactivetool_entry_point
    ADD CONSTRAINT interactivetool_entry_point_pkey PRIMARY KEY (id);


--
-- Name: job_container_association job_container_association_pkey; Type: CONSTRAINT; Schema: public; Owner: galaxydbuser
--

ALTER TABLE ONLY public.job_container_association
    ADD CONSTRAINT job_container_association_pkey PRIMARY KEY (id);
...
--
-- Name: ix_interactivetool_entry_point_job_id; Type: INDEX; Schema: public; Owner: galaxydbuser
--

CREATE INDEX ix_interactivetool_entry_point_job_id ON public.interactivetool_entry_point USING btree (job_id);
...
--
-- Name: ix_job_container_association_job_id; Type: INDEX; Schema: public; Owner: galaxydbuser
--

CREATE INDEX ix_job_container_association_job_id ON public.job_container_association USING btree (job_id);
...
--
-- Name: ix_workflow_step_input_workflow_step_id_name_unique; Type: INDEX; Schema: public; Owner: galaxydbuser
--

CREATE UNIQUE INDEX ix_workflow_step_input_workflow_step_id_name_unique ON public.workflow_step_input USING btree (workflow_step_id, name);
...
--
-- Name: workflow_invocation_output_dataset_collection_association fk_wiodca_dci; Type: FK CONSTRAINT; Schema: public; Owner: galaxydbuser
--

ALTER TABLE ONLY public.workflow_invocation_output_dataset_collection_association
    ADD CONSTRAINT fk_wiodca_dci FOREIGN KEY (dataset_collection_id) REFERENCES public.history_dataset_collection_association(id);


--
-- Name: workflow_invocation_output_dataset_collection_association fk_wiodca_wii; Type: FK CONSTRAINT; Schema: public; Owner: galaxydbuser
--

ALTER TABLE ONLY public.workflow_invocation_output_dataset_collection_association
    ADD CONSTRAINT fk_wiodca_wii FOREIGN KEY (workflow_invocation_id) REFERENCES public.workflow_invocation(id);


--
-- Name: workflow_invocation_output_dataset_collection_association fk_wiodca_woi; Type: FK CONSTRAINT; Schema: public; Owner: galaxydbuser
--

ALTER TABLE ONLY public.workflow_invocation_output_dataset_collection_association
    ADD CONSTRAINT fk_wiodca_woi FOREIGN KEY (workflow_output_id) REFERENCES public.workflow_output(id);


--
-- Name: workflow_invocation_output_dataset_collection_association fk_wiodca_wsi; Type: FK CONSTRAINT; Schema: public; Owner: galaxydbuser
--

ALTER TABLE ONLY public.workflow_invocation_output_dataset_collection_association
    ADD CONSTRAINT fk_wiodca_wsi FOREIGN KEY (workflow_step_id) REFERENCES public.workflow_step(id);


--
-- Name: workflow_invocation_step_output_dataset_collection_association fk_wisodca_dci; Type: FK CONSTRAINT; Schema: public; Owner: galaxydbuser
--

ALTER TABLE ONLY public.workflow_invocation_step_output_dataset_collection_association
    ADD CONSTRAINT fk_wisodca_dci FOREIGN KEY (dataset_collection_id) REFERENCES public.history_dataset_collection_association(id);


--
-- Name: workflow_invocation_step_output_dataset_collection_association fk_wisodca_wisi; Type: FK CONSTRAINT; Schema: public; Owner: galaxydbuser
--

ALTER TABLE ONLY public.workflow_invocation_step_output_dataset_collection_association
    ADD CONSTRAINT fk_wisodca_wisi FOREIGN KEY (workflow_invocation_step_id) REFERENCES public.workflow_invocation_step(id);


--
-- Name: workflow_invocation_step_output_dataset_collection_association fk_wisodca_wsi; Type: FK CONSTRAINT; Schema: public; Owner: galaxydbuser
--

ALTER TABLE ONLY public.workflow_invocation_step_output_dataset_collection_association
    ADD CONSTRAINT fk_wisodca_wsi FOREIGN KEY (workflow_step_id) REFERENCES public.workflow_step(id);


--
-- Name: form_definition_current form_definition_current_latest_form_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: galaxydbuser
--

ALTER TABLE ONLY public.form_definition_current
    ADD CONSTRAINT form_definition_current_latest_form_id_fkey FOREIGN KEY (latest_form_id) REFERENCES public.form_definition(id);
...
--
-- Name: interactivetool_entry_point interactivetool_entry_point_job_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: galaxydbuser
--

ALTER TABLE ONLY public.interactivetool_entry_point
    ADD CONSTRAINT interactivetool_entry_point_job_id_fkey FOREIGN KEY (job_id) REFERENCES public.job(id);


--
-- Name: job_container_association job_container_association_job_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: galaxydbuser
--

ALTER TABLE ONLY public.job_container_association
    ADD CONSTRAINT job_container_association_job_id_fkey FOREIGN KEY (job_id) REFERENCES public.job(id);
...
--
-- Name: workflow_step_connection workflow_step_connection_input_subworkflow_step_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: galaxydbuser
--
...
--
-- Name: workflow_step_connection workflow_step_connection_output_step_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: galaxydbuser
--
